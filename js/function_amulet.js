...
function filtre1() {
    ...
    if (filtresBox[0].checked == true) {
        for (let i = 0; i < itemBoxes.length; i++) {
            if (itemBoxes[i].classList.contains("rarityCharmN")) {
...
function filtre2() {
    ...
    if (filtresBox[1].checked == true) {
        for (let i = 0; i < itemBoxes.length; i++) {
            if (itemBoxes[i].classList.contains("rarityCharmE")) {
                itemBoxes[i].style.display = "block";
            }
        }
    } else {
...
function filtre3() {
    ...
    if (filtresBox[2].checked == true) {
        for (let i = 0; i < itemBoxes.length; i++) {
            if (itemBoxes[i].classList.contains("rarityCharmL")) {
                itemBoxes[i].style.display = "block";
            }
        }
    } else {
...
function filtre4() {
    ...
    if (filtresBox[3].checked == true) {
        for (let i = 0; i < itemBoxes.length; i++) {
            if (itemBoxes[i].classList.contains("rarityCharmMU")) {
                itemBoxes[i].style.display = "block";
            }
        }
    } else {
